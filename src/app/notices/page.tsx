      ...
      <section className="py-16 sm:py-20 bg-white border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    className={`btn-interactive px-3.5 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${
          ...
          {filteredNotices.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredNotices.map((notice, idx) => (
                <ScrollReveal key={notice.id} variant="fade-up" delay={idx * 80}>
          ...
          <ScrollReveal variant="fade-up" delay={150}>
            <div className="max-w-3xl mx-auto mt-14 bg-[#FAF8F2] border border-[#EDE2D3] rounded-2xl p-5 flex items-start gap-3 text-xs text-stone-700 shadow-xs">
